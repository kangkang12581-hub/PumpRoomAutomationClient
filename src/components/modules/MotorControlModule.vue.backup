<template>
  <div class="operation-module">
    ...
    <div class="motor-section">
        ...
        <div class="panel-content">
          <div class="grating-motor-layout">
            <!-- 运行参数区域 -->
            <div class="motor-params-section">
              <h4 class="section-title">运行参数</h4>
            ...
            <!-- 状态指示灯区域（统一为胶囊徽章样式） -->
            <div class="status-lights-section">
            ...
            <!-- 控制按钮区域 -->
            <div class="motor-controls-section">
              <div class="motor-status-indicator">
                ...
                <span class="status-text">{{ getMotorStatusText(gratingMotorData.status) }}</span>
                  ...
                  <!-- 紧凑型电机容器 -->
      <div class="compact-motors-container">
        <div class="motor-panel card fade-in-up compact-motor" style="animation-delay: 0.3s">
        <h3 class="panel-title">
        ...
        <div class="motor-panel card fade-in-up compact-motor" style="animation-delay: 0.4s">
          <h3 class="panel-title">
                  <svg width="16" height="16" viewBox="0 0 24 24" fill="none">
              <path d="M12 2L2 7L12 12L22 7L12 2Z" stroke="currentColor" stroke-width="2"/>
              <path d="M2 17L12 22L22 17" stroke="currentColor" stroke-width="2"/>
      ...
      <div class="system-control-panel card fade-in-up" style="animation-delay: 0.7s">
        ...
        <div class="panel-content">
          <div class="control-modules">
            ...
            <!-- 报警确认模块 -->
            <div class="control-module">
              <h4 class="module-title">报警确认</h4>
              <div class="alarm-confirm-controls">
                <div class="reset-info">
                  <div class="info-icon">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
                  ...
                  <div class="info-text">
                    <p class="info-title">报警管理</p>
                    <p class="info-desc">确认并清除当前站点所有活跃报警</p>
                  </div>
                </div>
                <div class="reset-buttons">
                  <button 
                    ...
                    :disabled="loading || confirmingAlarms"
                  >
                    <svg width="16" height="16" viewBox="0 0 24 24" fill="none">
                      <path d="M9 12L11 14L15 10" stroke="currentColor" stroke-width="2"/>
                      <circle cx="12" cy="12" r="10" stroke="currentColor" stroke-width="2"/>
                    </svg>
                    {{ confirmingAlarms ? '确认中...' : '确认所有报警' }}
                  </button>
                </div>
              </div>
            </div>
...
.operation-module::-webkit-scrollbar {
  width: 8px;
}

.operation-module::-webkit-scrollbar-track {
  background: #f1f5f9;
  border-radius: 4px;
}

.operation-module::-webkit-scrollbar-thumb {
  background: #cbd5e0;
  border-radius: 4px;
}

.operation-module::-webkit-scrollbar-thumb:hover {
  background: #94a3b8;
}
...
.motor-section {
  display: grid;
  grid-template-columns: 1fr minmax(280px, 300px) 1fr;
  gap: 24px;
  grid-template-areas: 
    "grating compact-motors scale";
}
...
.motor-section .compact-motors-container {
  grid-area: compact-motors;
  display: flex;
  flex-direction: column;
  gap: 16px;
}
...
@media (max-width: 1200px) {
  .motor-section {
    ...
    grid-template-areas: 
      "grating scale"
      "compact-motors compact-motors";
  }
  
  .compact-motors-container {
    flex-direction: row;
    justify-content: center;
    gap: 20px;
  }
